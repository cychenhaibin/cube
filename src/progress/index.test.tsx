...
describe('Progress', () => {
  ...
  it('should render correct status', () => {
    const { container, rerender } = render(<Progress percent={100} status="success" />);
    ...
    expect(container.querySelectorAll('.ci-pg-status-exception')).toHaveLength(1);
  });
  ...
  it('should render stroke color', () => {
    ...
    expect(container.firstChild).toMatchSnapshot();
    rerender(<Progress strokeColor="red" percent={50} type="circle" status="success" />);
    expect(container.firstChild).toMatchSnapshot();
    rerender(<Progress strokeColor="red" percent={50} type="circle" status="exception" />);
    expect(container.firstChild).toMatchSnapshot();
  });
